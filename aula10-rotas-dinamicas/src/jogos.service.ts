...
export class JogosService {
    ...
    buscarPorId(id:number){
        ...
        if(!jogo){
            throw new NotFoundException(`Jogo com ID ${id} não localizado em nosso gromório.`);
        }
        return jogo;
    }
}